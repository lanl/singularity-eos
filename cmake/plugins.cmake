    ...
    if(SINGULARITY_USE_KOKKOS)
      if(Kokkos_ENABLE_COMPILE_AS_CMAKE_LANGUAGE)
        ...
        if(ext IN_LIST CMAKE_CXX_SOURCE_FILE_EXTENSIONS)
          message(STATUS "file ${arg} is cxx")
	  message(STATUS "kokkos compile language is: ${Kokkos_COMPILE_LANGUAGE}")
          set_source_files_properties(${CMAKE_CURRENT_SOURCE_DIR}/${arg} PROPERTIES LANGUAGE CUDA)
        endif()
      endif()
    endif()
