...
class Eospac(Package):
    ...
    def install(self, spec, prefix):
        with working_dir('Source'):
            ...
            # lmdm: 2019.10.15
            #   eospac installs its own getopt which conflicts with the
            #   system getopt.  If this getopt ends up in your path
            #   (eg "spack load eospac"), you get all sorts of strangeness
            #   in spack or anything that ends up using getopt.
            #   Hacking its spackage to not install its getopt.
            bad_file = os.path.join(prefix.bin,'getopt')
