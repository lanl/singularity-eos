...
template class ScaledEOS<IdealGas>;
template class ScaledEOS<Gruneisen>;
template class ScaledEOS<Vinet>;
template class ScaledEOS<MGUsup>;
template class ScaledEOS<PowerMG>;
template class ScaledEOS<JWL>;
template class ScaledEOS<DavisReactants>;
template class ScaledEOS<DavisProducts>;
