...
class PTESolverBase {
 public:
  ...
  void PrintSpec() const {
    ...
    for (int m = 0; m < nmat; ++m) {
      printf("r: %e vf: %e T: %e s: %e p: %e\n", rho[m], vfrac[m], temp[m] * Tnorm,
             sie[m] * uscale, press[m] * uscale);
    }
    return;
  }
  ...
  void InitBase() {
    ...
    for (int m = 0; m < nmat; m++) {
      ...
      if (eos[m].PreferredInput() ==
        ...
        press[m] =
            eos[m].PressureFromDensityInternalEnergy(rho[m], sie[m], Cache[m]) / uscale;
  ...
  PORTABLE_INLINE_FUNCTION void TryIdealPTE(T *solver) {
    ...
    for (int m = 0; m < nmat; ++m) {
      ...
      if (eos[m].PreferredInput() ==
          (thermalqs::density | thermalqs::specific_internal_energy)) {
        press[m] =
            eos[m].PressureFromDensityInternalEnergy(rho[m], sie_m, Cache[m]) / uscale;
      } else if (eos[m].PreferredInput() ==
                 (thermalqs::density | thermalqs::temperature)) {
        press[m] =
  ...
  void Jacobian() const {
    ...
    for (int m = 0; m < nmat; m++) {
      ...
      if (eos[m].PreferredInput() ==
          (thermalqs::density | thermalqs::specific_internal_energy)) {
        p_pert =
            eos[m].PressureFromDensityInternalEnergy(rho_pert, e_pert, Cache[m]) / uscale;
      } else if (eos[m].PreferredInput() ==
                 (thermalqs::density | thermalqs::temperature)) {
        p_pert =
      ...
      if (eos[m].PreferredInput() ==
          (thermalqs::density | thermalqs::specific_internal_energy)) {
        p_pert =
            eos[m].PressureFromDensityInternalEnergy(rho[m], e_pert, Cache[m]) / uscale;
      } else if (eos[m].PreferredInput() ==
                 (thermalqs::density | thermalqs::temperature)) {
  ...
  void Jacobian() const {
    ...
    for (int m = 0; m < nmat; m++) {
      ...
      if (eos[m].PreferredInput() ==
          (thermalqs::density | thermalqs::specific_internal_energy)) {
        p_pert =
            eos[m].PressureFromDensityInternalEnergy(rho_pert, sie[m], Cache[m]) / uscale;
      } else if (eos[m].PreferredInput() ==
                 (thermalqs::density | thermalqs::temperature)) {
        p_pert =
      ...
      if (eos[m].PreferredInput() ==
          (thermalqs::density | thermalqs::specific_internal_energy)) {
        p_pert =
            eos[m].PressureFromDensityInternalEnergy(rho[m], uscale * e_pert, Cache[m]) /
            uscale;
      } else if (eos[m].PreferredInput() ==
                 (thermalqs::density | thermalqs::temperature)) {
