...
using singularity::CRESTReactants;

SCENARIO("CRESTReactants EOS", "Check if eos returns expected values") {
  GIVEN("Parameters for a CRESTReactants EOS") {
    // Unit conversions
    ...
    // Create the EOS
    EOS host_eos = CRESTReactants(rho0, a0, a1, a2c, a2e, a3, b0, b1, b2c, b2e, b3);
